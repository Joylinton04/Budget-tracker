                    ...
                    return(
                        <div className="mt-4 relative rounded-lg border-2 w-full p-2 hover:bg-slate-200" key={budget.id}>
                            <Link to={`/budget/${budget.id}/expense`} className='flex flex-col gap-4 p-2 w-full'>
                                <h1 className='capitalize font-semibold md:text-2xl'>{budget.category}</h1>
                                <div className="flex justify-between items-center flex-wrap">
                                    <div className="w-[50px] h-[50px] lg:w-16 lg:h-16 md:w-10 md:h-10 bg-blue-400 rounded-full grid place-content-center text-2xl text-white" style={bgStyles[budget.category]}>{budget.category[0]}</div>
                                    ...
                                    <div><p className='font-semibold md:text-lg p-2 lg'>Budget: {budget.amount}$</p></div>
                                </div>
                            </Link>
